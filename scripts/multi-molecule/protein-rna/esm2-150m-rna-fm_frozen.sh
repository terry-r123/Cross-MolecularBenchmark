...
DATA_PATH=${data_root}multi-omics/multi-omics/downstream/ncRNAProteinInter

omics1_model_type='esm2-150m'
omics2_model_type='rna-fm'
...
OMICS2_MODEL_PATH=${data_root}multi-omics/RNA/model/opensource/rna-fm
...
do
    ...
    do
        ...
        ${EXEC_PREFIX} \
        downstream/train_protein_rna_inter.py \
