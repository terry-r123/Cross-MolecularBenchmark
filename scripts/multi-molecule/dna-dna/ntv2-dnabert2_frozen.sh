...
OMICS1_MODEL_PATH=${data_root}multi-omics/DNA/model/opensource/nt/${omics1_model_type}
OMICS2_MODEL_PATH=${data_root}multi-omics/DNA/model/opensource/DNABERT2/
