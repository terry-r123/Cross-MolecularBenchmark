...
omics1_model_type='sota'
omics2_model_type='sota'
...
omics1_model_max_length=3000
omics2_model_max_length=2000
#lr=1e-5
data=''

OMICS1_MODEL_PATH=/home/bingxing2/ailab/group/ai4bio/renyuchen/multi-omic/model/sota/rnalm-single-ape
OMICS2_MODEL_PATH=/home/bingxing2/ailab/group/ai4bio/renyuchen/multi-omic/model/sota/rnalm-single-ape
...
do
    ...
    do
        ...
        ${EXEC_PREFIX} \
        downstream/train_enhancer_promoter_inter_sota.py \
