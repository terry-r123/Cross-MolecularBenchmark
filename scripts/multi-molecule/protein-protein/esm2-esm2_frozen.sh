...
task_type='multi'
data_file_train=train.csv; data_file_val=val.csv; data_file_test=test_unseen.csv
...
DATA_PATH=${data_root}multi-omics/multi-omics/downstream/AntibodyAntigen

omics1_model_type='esm2'
omics2_model_type='esm2'
...
OMICS1_MODEL_PATH=${data_root}multi-omics/protein/model/esm2_t30_150M_UR50D
OMICS2_MODEL_PATH=${data_root}multi-omics/protein/model/esm2_t30_150M_UR50D
...
do
    ...
    do
        ...
        ${EXEC_PREFIX} \
        downstream/train_antibody_antigen_neutralizability.py \
