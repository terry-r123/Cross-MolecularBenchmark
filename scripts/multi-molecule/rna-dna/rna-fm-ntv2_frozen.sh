...
task='rna-dna' # omics1: sgRNA,  omics2: DNA
task_type='multi'
...
DATA_PATH=${data_root}multi-omics/multi-omics/downstream/CRISPROffTarget

omics1_model_type='rna-fm'
...
OMICS1_MODEL_PATH=${data_root}multi-omics/RNA/model/opensource/rna-fm
...
for seed in 42
do
    for lr in  9e-6 7e-6 5e-6 3e-6 3e-5 5e-5 #1e-5 #3e-5 5e-5 #7e-5 9e-6 7e-6 5e-6
    do
        ...
        ${EXEC_PREFIX} \
        downstream/train_sgrna_dna_inter.py \
