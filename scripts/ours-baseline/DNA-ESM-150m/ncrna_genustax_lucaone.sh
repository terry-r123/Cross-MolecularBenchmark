...
MODEL_PATH=/home/bingxing2/ailab/group/ai4bio/public/multi-omics/DNA/model/ours/dna-esm-150m-multi/checkpoint-1000000
OUTPUT_PATH=./outputs/ft/dna-all/${task}/dna/ours-baseline/${MODEL_TYPE}  
