...
if [ "$USE_SLURM" == "1" ]; then
    ...
    data_root=/home/bingxing2/ailab/group/ai4bio/public/multi-omics/lucaone/DownstreamTasksDataset/dataset/ncRNAFam/gene/multi_class
...
OUTPUT_PATH=./outputs/ft/rna-all/${task}/rna/ours-baseline/${MODEL_TYPE}  
...
do
    ...
    do 
        ...
        ${EXEC_PREFIX} \
        downstream/train_ncrna_lucaone.py \
