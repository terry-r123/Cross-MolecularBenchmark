...
try:
    ...
    from model.lucagplm.v0_2.model_utils import AllOutput, create_output_loss_lucagplm
    from model.lucagplm.v0_2.alphabet import Alphabet
    from model.lucagplm.v0_2.modeling_gplm import *
