...
try:
    from .modeling_bert import BertPooler, BertModel, BertEncoder
except ImportError:
    from model.common.modeling_bert import BertPooler, BertModel, BertEncoder


def create_pooler(pooling_type, hidden_size):
    '''
    pooler building
    :param config:
    :param args:
