...
os.environ["WANDB_PROJECT"] = "programmable_rna_switches"
...
def train():
    ...
    elif training_args.model_type in ['esm2', 'rna-fm','rnabert','rnamsm','splicebert-human510','splicebert-ms510','splicebert-ms1024','utrbert-3mer','utrbert-4mer','utrbert-5mer','utrbert-6mer','utr-lm-mrl','utr-lm-te-el']:
